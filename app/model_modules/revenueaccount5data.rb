module Revenueaccount5data
    ...
    def table(b, rain_fall_type, _year, ji, compare)
        ...
        if rain_fall_type 
          ...
          hash_data = ji.map do |el|
            if el.to_s == 'Transfer_of_Resources'
              { title: 'Transfer of Resources', field: el, headerFilter: true }
            else
          ...
          if compare == 'None'
            hash_data = [
              { title: 'Transfer of Resources', field: 'Transfer_of_Resources', headerFilter: true },
       ...
       if _year == "All"
        grouped = {}
          b.each do |x|
            grouped[x[:Transfer_of_Resources]] ||= {}
            grouped[x[:Transfer_of_Resources]][:Transfer_of_Resources] = x[:Transfer_of_Resources]
            grouped[x[:Transfer_of_Resources]][x[:Year]] = x[:Amount]
          end
