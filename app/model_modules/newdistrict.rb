module Newdistrict
    ...
    #  abort(rain_fall_type)
      ...
      hu = {below_min: {min: below_min.first[:y], max: below_min.last[:y]},min: {min: min.first[:y], max: min.last[:y]}, blow_max:{min: blow_max.first[:y], max: blow_max.last[:y]}, max:{min: max.first[:y], max: max.last[:y]},above_max:{min: above_max.first[:y], max: above_max.last[:y]},extreme:{min: extreme.first[:y], max: extreme.last[:y]},above_extreme:{max: 120}}
