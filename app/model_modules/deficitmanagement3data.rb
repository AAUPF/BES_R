module Deficitmanagement3data
    ...
    def table(b, rain_fall_type, _year, ji, compare)
      ...
      if rain_fall_type == 'All'
        ...
        if compare == 'None'
          hash_data = [
            { title: 'District', field: 'Gross_Fiscal_Deficit', headerFilter: true },
      ...
      #     j.push({id: k.id, Productivity: u ,Gross_Fiscal_Deficit: k.Gross_Fiscal_Deficit, Area: k.Area, Production: k.Production, Year: k.Year })
      #   else
      #     j.push(k)
      #   end
      # end
