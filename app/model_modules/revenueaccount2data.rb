module Revenueaccount2data
    ...
    def table(b, rain_fall_type, _year, ji, compare)
      ...
      #     j.push({id: k.id, Productivity: u ,Expenditure_Pattern: k.Expenditure_Pattern, Area: k.Area, Production: k.Production, Year: k.Year })
      #   else
      #     j.push(k)
      #   end
      # end
      ...
      if rain_fall_type == 'All'
        ...
        if compare
          if _year == "All"
            ...
            { y: value[rain_fall_type], label: value[:Expenditure_Pattern] }
            }
            }
            }
          else
