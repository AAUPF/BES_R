...
#   def self.search(search, compare, year, rain_fall_type,district1)
#           if search == "None"
#               getit = district1
#           else
#               getit = search
...
#         if el.to_s == 'Revenue_Account'
#           { title: 'Revenue Account', field: el, headerFilter: true }
#         else
...
#       if compare == 'None'
#         hash_data = [
#           { title: 'Revenue Account', field: 'Revenue_Account', headerFilter: true },
...
#     else
#       # where(Revenue_Account: search)
#       where(Year: year).order(rain_fall_type)
#     end
#   end

#   def self.query(b, _year, rain_fall_type, views, ji, compare,search,district1)
#     d = 'Revenue_Account'
#     color  = "#4f81bc"
#     if rain_fall_type == 'All'
#       if views
...
#                       legendText:"#{el["Year"]}",
#                       showInLegend: true,
#                       dataPoints: [{ y: el[rain_fall_type], label:el["Revenue_Account"] }]
#                   }
#                   end
...
#                       type:views,
#                       toolTipContent: "{label}<br/>{name}, <strong>{y}</strong>",
#                       name:"#{el["Revenue_Account"]}",
#                       legendText:"#{el["Revenue_Account"]}",
#                       showInLegend: true,
...
#               showInLegend: true,
#               dataPoints: b.map do |el|
#                 { y: el[rain_fall_type], label: el['Revenue_Account'] }
#                           end
#             }]
#         end
...
#         elsif (6..12) === i
#           hash1 = { y: el[rain_fall_type], label: dist, color: "Orange" }
#           # hash1 = { y: el[rain_fall_type], label: el["Revenue_Account"] }
#           min.push(hash1)
#         elsif (12..18) === i
#           hash1 = { y: el[rain_fall_type], label: dist, color: "Dark_Yellow" }
#           # hash1 = { y: el[rain_fall_type], label: el["Revenue_Account"] }
