class ResourceManagement7 < ApplicationRecord
      ...
      if rain_fall_type 
        ...
        hash_data = ji.map do |el|
          if el.to_s == 'Revenue_Sources'
            { title: 'Revenue_Sources', field: el, headerFilter: true }
          else
        ...
        if compare == 'None'
          hash_data = [
            { title: 'Revenue_Sources', field: 'Revenue_Sources', headerFilter: true },
     ...
     if _year == "All"
      grouped = {}
        b.each do |x|
          ...
          grouped[x[:Revenue_Sources]][x[:Year]] = x[:Percentage]
        end
