...
class AnimalHusbandry2sController < ApplicationController
  before_action :set_animal_husbandry2, only: %i[show edit update destroy]
  ...
  def test
    ji = %i[Milk_lakh_tonnes Egg_crore Wool_lakh_kgs Meat_lakh_tonnes Fish_lakh_tonnes]
    rain_fall_type = params[:rain_fall_type]
    views = params[:views]
    year = params[:year]
    compare = params[:compare]
    ji1 = %i[Year Milk_lakh_tonnes Egg_crore Wool_lakh_kgs Meat_lakh_tonnes Fish_lakh_tonnes]
