...
# if year == "All"
#   ji1 = [:Transfer_of_Resources, :"2012-13", :"2013-14",:"2014-15",:"2015-16",:"2016-17",:"2017-18_BE"]
#  else
...
#         a = RevenueAccount5.query(@RevenueAccount5s,params[:year],rain_fall_type,views,ji,compare,search)
#       end
...
def test
  ...
  rain_fall_type = params[:rain_fall_type]
   ...
   if year == "All"
    ...
    if rain_fall_type != "All"
      ji1 = [:Transfer_of_Resources, "#{rain_fall_type}", :Year]
  ...
  if rain_fall_type || views
    ...
    if views == "Map View"
      ...
      b = RevenueAccount5.search(params[:search],compare,year,rain_fall_type,legend)
      a = RevenueAccount5.table(b,rain_fall_type,year,ji1,compare,legend)
    else
      @RevenueAccount5 = RevenueAccount5.search(params[:search],compare,year,rain_fall_type,legend)
      a = RevenueAccount5.query(@RevenueAccount5,params[:year],rain_fall_type,views,ji,compare,search,legend,remove)
    end
    respond_to do |format|
      format.html { render json:a }
  end
