...
# def test
#   ji = [:Districts, :Affiliated_College, :Constituent_College, :Year]
...
#          end
#       elsif views == "Table"  
#         b = DistrictWiseSection8.search(params[:search],compare,year,rain_fall_type)
#         a = DistrictWiseSection8.table(b,rain_fall_type,year,ji1,compare)
#       else
#         @DistrictWiseSection8s = DistrictWiseSection8.search(params[:search],compare,year,rain_fall_type)
#         a = DistrictWiseSection8.query(@DistrictWiseSection8s,params[:year],rain_fall_type,views,ji,compare)
#       end
