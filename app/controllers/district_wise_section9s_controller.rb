...
# def test
#   ji = [:Districts, :Districts, :Constituent_College, :Total, :Science_Arts_Commerce_College, :Engineering, :Medical, :B_Ed, :Others, :All_Colleges]
...
#         a = DistrictWiseSection9.query(@DistrictWiseSection9s,params[:year],rain_fall_type,views,ji,compare)
#       end
