...
ji1 = [:Districts, :NRHM_Total, :Year]
  if rain_fall_type || views
      ...
      if views == "Map View"
        ...
        b = Health22.search(params[:search],compare,year,rain_fall_type)
        a = Health22.table(b,rain_fall_type,year,ji1,compare)
      else
        @Health22s = Health22.search(params[:search],compare,year,rain_fall_type)
        a = Health22.query(@Health22s,params[:year],rain_fall_type,views,ji,compare)
      end
