...
class ProductionProductivity11sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production_productivity11" do
    assert_difference('ProductionProductivity11.count') do
      post production_productivity11s_url, params: { production_productivity11: { Brinjal_Area: @production_productivity11.Brinjal_Area, Brinjal_Production: @production_productivity11.Brinjal_Production, Cauliflower_Area: @production_productivity11.Cauliflower_Area, Cauliflower_Production: @production_productivity11.Cauliflower_Production, Districts: @production_productivity11.Districts, Onion_Area: @production_productivity11.Onion_Area, Onion_Production: @production_productivity11.Onion_Production, Percentage_Brinjal_Area: @production_productivity11.Percentage_Brinjal_Area, Percentage_Brinjal_Production: @production_productivity11.Percentage_Brinjal_Production, Percentage_Cauliflower_Area: @production_productivity11.Percentage_Cauliflower_Area, Percentage_Cauliflower_Production: @production_productivity11.Percentage_Cauliflower_Production, Percentage_Onion_Area: @production_productivity11.Percentage_Onion_Area, Percentage_Onion_Production: @production_productivity11.Percentage_Onion_Production, Percentage_Potato_Area: @production_productivity11.Percentage_Potato_Area, Percentage_Potato_Production: @production_productivity11.Percentage_Potato_Production, Potato_Area: @production_productivity11.Potato_Area, Potato_Production: @production_productivity11.Potato_Production, Year: @production_productivity11.Year } }
    end
