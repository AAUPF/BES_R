...
class ProductionProductivity7sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production_productivity7" do
    assert_difference('ProductionProductivity7.count') do
      post production_productivity7s_url, params: { production_productivity7: { Area: @production_productivity7.Area, Districts: @production_productivity7.Districts, Production: @production_productivity7.Production, Productivity: @production_productivity7.Productivity, Year: @production_productivity7.Year } }
    end
  ...
  test "should update production_productivity7" do
    patch production_productivity7_url(@production_productivity7), params: { production_productivity7: { Area: @production_productivity7.Area, Districts: @production_productivity7.Districts, Production: @production_productivity7.Production, Productivity: @production_productivity7.Productivity, Year: @production_productivity7.Year } }
