...
class ProductionProductivity9sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production_productivity9" do
    assert_difference('ProductionProductivity9.count') do
      post production_productivity9s_url, params: { production_productivity9: { Area: @production_productivity9.Area, Districts: @production_productivity9.Districts, Percentage_Area: @production_productivity9.Percentage_Area, Percentage_Production: @production_productivity9.Percentage_Production, Production: @production_productivity9.Production, Productivity: @production_productivity9.Productivity, Year: @production_productivity9.Year } }
    end
  ...
  test "should update production_productivity9" do
    patch production_productivity9_url(@production_productivity9), params: { production_productivity9: { Area: @production_productivity9.Area, Districts: @production_productivity9.Districts, Percentage_Area: @production_productivity9.Percentage_Area, Percentage_Production: @production_productivity9.Percentage_Production, Production: @production_productivity9.Production, Productivity: @production_productivity9.Productivity, Year: @production_productivity9.Year } }
