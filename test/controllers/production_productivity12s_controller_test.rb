...
class ProductionProductivity12sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create production_productivity12" do
    assert_difference('ProductionProductivity12.count') do
      post production_productivity12s_url, params: { production_productivity12: { Area: @production_productivity12.Area, Districts: @production_productivity12.Districts, Production: @production_productivity12.Production, Year: @production_productivity12.Year, Yield: @production_productivity12.Yield } }
    end
  ...
  test "should update production_productivity12" do
    patch production_productivity12_url(@production_productivity12), params: { production_productivity12: { Area: @production_productivity12.Area, Districts: @production_productivity12.Districts, Production: @production_productivity12.Production, Year: @production_productivity12.Year, Yield: @production_productivity12.Yield } }
